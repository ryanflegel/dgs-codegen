...
class ClientApiGenerator(
    ...
    private fun addFragmentProjectionMethod(
        ...
        val projectionName = "${fragmentType.name.capitalized()}Fragment"
        ...
        javaType.addMethod(
            MethodSpec
                .methodBuilder("on${fragmentType.name}")
                .addModifiers(Modifier.PUBLIC)
                .returns(typeVariable)
                .addCode(
                    """
        ...
        return createFragment(fragmentType, rootType, projectionName, processedEdges, queryDepth)
    }
